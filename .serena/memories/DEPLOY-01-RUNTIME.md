...
## Facts
- Bootstrap deployment means a plan/apply/verify host transaction with preservation and rollback boundaries; application workloads are deployed elsewhere.
