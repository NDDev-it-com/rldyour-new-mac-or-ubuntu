...
## Facts
- Bootstrap quality is proven by shell lint/validation, pytest fault-injection coverage, type/lint checks, workflow lint, and target-host verification where required.
